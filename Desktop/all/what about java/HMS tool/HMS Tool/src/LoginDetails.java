...
PreparedStatement pst=null;
    ...
    public LoginDetails() {
        ...
        // here we simply called the function getdata which basically do the process of 
        // getting the data form the database then put it into the table accordingly for it 
        Get_Data();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBackground(new java.awt.Color(99, 99, 156));
        jScrollPane1.setForeground(new java.awt.Color(20, 20, 31));

        User_table.setBackground(new java.awt.Color(255, 153, 153));
